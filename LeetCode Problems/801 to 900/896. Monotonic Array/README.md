...
<div class="elfjS" data-track-load="description_content"><p>An array is <strong>monotonic</strong> if it is either monotone increasing or monotone decreasing.</p>
